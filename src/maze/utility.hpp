...
std::deque<Direction>
GetValidMoveDirections(MoveValidityCheck validity_check = nullptr);

std::deque<Direction>
GetRandomizedMoveDirections(MoveValidityCheck validity_check = nullptr);

std::optional<Direction>
GetRandomMoveDirection(MoveValidityCheck validity_check = nullptr);
...
template <> struct std::hash<maze::Position> {
