...
MazeFigure::FigureVertexData MazeFigure::GetWallTemplate(const GLfloat &height, const GLfloat &side_of_a_base, const glm::vec3 &celling_color, const glm::vec2 &wall_shading){
  const GLfloat half_of_side = side_of_a_base / 2.0f;
